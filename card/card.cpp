...
BEGIN_MESSAGE_MAP(CcardApp, CWinAppEx)
...
CcardApp::CcardApp()
{
	...
	SetAppID(_T("card.AppID.NoVersion"));
...
void CcardApp::LoadCustomState()
{
}

void CcardApp::SaveCustomState()
{
}
